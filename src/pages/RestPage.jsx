...
export const RestPage = () => {
  ...
  const [userData, setUserData] = useState({
    reason: "Descanso por Vacaciones",
    location: "CDMX",
        ...
        <form className="">
          ...
          <div className="flex gap-2 mt-4 flex-wrap">
            ...
            <select 
              ...
              onChange={(e) => handlerForm(e)}
            >
              <option value="Descanso por Vacaciones">Descanso por Vacaciones</option>
              <option value="Incapacidad">Incapacidad</option>
              <option value="Descanso por un dia">Descanso por un dia</option>
              <option value="Descanso por paternidad">Descanso por paternidad</option>
